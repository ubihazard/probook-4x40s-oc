...
5.  Trackpad [configuration](https://github.com/ubihazard/probook-4x30s-oc#configuring-trackpad) is identical to previous gen ProBooks. For 40s series we are still using older `VoodooPS2Controller.kext` from RehabMan. The Acidanthera [fork with Magic Trackpad II emulation](https://github.com/acidanthera/VoodooPS2) unfortunately doesn’t appear to support Synaptics hardware used in these old ProBooks.
