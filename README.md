...
[^1]: Webcam works up to Mojave. USB, Bluetooth and webcam need proper [USB port mapping](#fixing-usb). SD card reader kext can sometimes hang on file operations due to being very old and outdated.
