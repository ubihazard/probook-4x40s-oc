...
#ifdef QUIET
DefinitionBlock ("", "SSDT", 2, "HPHACK", "FanQ", 0)
#endif
#ifdef REHABMAN
DefinitionBlock ("", "SSDT", 2, "HPHACK", "FanRM", 0)
#endif
#ifdef GRAPPLER
DefinitionBlock ("", "SSDT", 2, "HPHACK", "FanGrap", 0)
#endif
#ifdef UBIHAZARD
DefinitionBlock ("", "SSDT", 2, "HPHACK", "FanUbi", 0)
#endif
{
    ...
    Device (SMCD)
    {
...
#endif
#ifdef UBIHAZARD
        // Smooth and quiet fan curve without allowing
        // laptop chassis getting too hot at idle
        Name(FTA1, Package()
        {
            45,  46,  48,  50,  52,  54,  56,  58,  60,  62,
            64,  65,  66,  67,  68,  69,  70,  71,  72,  73,
            74,  75,  76,  77,  78,  79,  80,  81,  82,  83,
            84,  85,  86,  87,  88,  89,  90, 0xFF
        })
        Name(FTA2, Package()
        {
           255, 128, 122, 116, 112, 110, 110, 109, 108, 106,
           104, 102,  98,  96,  94,  92,  84,  82,  80,  77,
            75,  73,  70,  68,  67,  66,  64,  63,  61,  60,
            58,  57,  53,  52,  51,  50,  49,   0
        })
        Name (FCTU, 10)  // timeout for changes (fan rpm going up)
        Name (FCTD, 20)  // timeout for changes (fan rpm going down)
#endif
#ifdef UBIHAZARD_
        // another alternate by Ubihazard
        Name(FTA1, Package()
        {
            45,  50,  60,  62,  64,  65,  66,  67,  68,  69,
        ...
        Name(FTA2, Package()
        {
           255, 128, 120, 116, 112, 108, 102, 100,  98,  96,
            92,  91,  89,  88,  86,  84,  82,  80,  78,  76,
            72,  70,  67,  65,  63,  61,  58,  56,  54,  50,
            49,   0
        })
        Name (FCTU, 10)  // timeout for changes (fan rpm going up)
        Name (FCTD, 20)  // timeout for changes (fan rpm going down)
