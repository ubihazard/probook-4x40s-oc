 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "17F6    ", 0x00000001)
{
    /*
    ...
    OperationRegion (GNVS, SystemMemory, 0xA9F79918, 0x01C6)
    ...
    OperationRegion (ASMA, SystemMemory, 0xA9F7B018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xA9F7D018, 0x0D5D)
    ...
    OperationRegion (HPDF, SystemMemory, 0xA9F7EE18, 0x017D)
    ...
    OperationRegion (HPD2, SystemMemory, 0xA9A25F18, 0x006D)
    ...
    OperationRegion (HPBR, SystemMemory, 0xA9F7AF18, 0x007E)
        ...
        Method (WQBI, 1, Serialized)
        {
            ...
            Switch (Arg0)
            {
                Case (0x00)
                {
                    ...
                    ElseIf (LGreater (Local1, Add (Local0, 0xC8)))
                    {
                    ...
                    Method (GBTC, 0, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            If (And (BATP, 0x01))
                            {
                                ...
                                ElseIf (LAnd (LAnd (LAnd (LEqual (INAC, 0x00), LEqual (INCH, 0x02)), LEqual (IDIS, 0x01)), LEqual (MAXC, 0x00)))
                                {
                                ...
                                ElseIf (LAnd (LAnd (LAnd (LEqual (INAC, 0x00), LEqual (INCH, 0x02)), LEqual (IDIS, 0x01)), LEqual (MAXC, 0xFA)))
                                {
                            ...
                            If (And (BATP, 0x02))
                            {
                                ...
                                ElseIf (LAnd (LAnd (LAnd (LEqual (INAC, 0x00), LEqual (INCH, 0x01)), LEqual (IDIS, 0x02)), LEqual (MAXC, 0x00)))
                                {
                                ...
                                ElseIf (LAnd (LAnd (LAnd (LEqual (INAC, 0x00), LEqual (INCH, 0x01)), LEqual (IDIS, 0x02)), LEqual (MAXC, 0xFA)))
                                {
                ...
                If (LEqual (Arg1, 0x01))
                {
                    ...
                    If (LEqual (Local2, 0x01))
                    {
                        ...
                        ElseIf (\SRCP (DerefOf (Index (Local0, 0x0E)), NONO))
                        {
                            ...
                            ElseIf (LEqual (\SRCM (ST01, "Reset BIOS security to factory default", 0x26), 0x00))
                            {
                                Store (0x01, PCHG)
                            }
                        }
                    ...
                    While (LLess (Local0, 0xFD))
                    {
                        ...
                        While (LLess (Local2, Local4))
                        {
                            ...
                            If (LAnd (LGreater (Local7, 0x00), LLess (Local7, 0x0A)))
                            {
                                ...
                                {
                                    Store (DerefOf (Index (DerefOf (Index (DYEN, Add (Local2, 0x01))), 0x00)), Local5)
